  ...
  return (
    <>
      <aside
        ...
        className={`fixed inset-y-0 left-0 z-40 flex w-64 shrink-0 flex-col border-r border-line bg-card transition-[transform,visibility] duration-300 lg:sticky lg:top-0 lg:h-screen lg:visible lg:translate-x-0 ${
